...
0     &       0        &         0      &    1
	...
	\begin{figure}[h!]
		\begin{center}
		\includegraphics[width=3.5cm, height=4.0cm]{/link_description.png}
