...
%%  ----------------------------------------------
	...
	\section{Algoritmo RANSAC}
		...
		\begin{figure}[h!]
			\begin{center}
			\includegraphics[width=7.5cm, height=6.0cm]{/planeEquation.png}	
	...
	\section{Algoritmo PCA}
		...
		\subsection{Desviación estándar}
			...
			\begin{figure}
				\begin{center}
				\includegraphics[width=10.5cm, height=7.0cm]{/standarDeviation4.jpg}	
