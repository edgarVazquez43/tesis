...
\chapter{Marco teórico}
	\section{Robots de servicio}
		...
		\begin{figure}[htb]
			\begin{center}
			\includegraphics[width=8.5cm, height=5cm]{/cosero.png}
		...
		\begin{figure}[htb]
			\begin{center}
			\includegraphics[width=8.5cm, height=5cm]{/markovito.png}
			\caption{Estructura de software del robot Cosero.}
			\end{center}
		\end{figure}
		...
		\begin{figure}[htb]
			\begin{center}
			\includegraphics[width=8.5cm, height=5cm]{/justina.png}
			\caption{Estructura de software del robot Cosero.}
			\end{center}
		\end{figure}
...
%%  ----------------------------------------------
	...
	\section{Algoritmo RANSAC}
		...
		\begin{algorithmic}
			...
			\State{mejorError = Algo realemente grande}\\
		...
		Sea $p_1=(x_1, y_1, z_1)$, $p_2=(x_2, y_2, z_2)$, y $p_3=(x_3, y_3, z_3)$ puntos en el estacio $R^3$ no-colineales.\\

		Este plano también puede ser descrito por el "punto y un vector normal" prescripción anterior. Un vector normal adecuado se da por el producto cruz.\\
		...
		De lo cual podemos obervar que el punto $p_1$ se encuentra en el plano si y sólo si $D = 0$.\\
	...
	\section{Algoritmo PCA}
		...
		\subsection{Desviación estándar}
			...
			Por tanto para calcular la desviación estándar primero debemos calcular la media del conjuto de datos.\\
			...
			Donde $n$ es el numero totalo de datos contenido en la muestra.\\
		...
		\subsection{Varianza}
			...
			Por lo que respecta a su representación matemática se puede expresar como el cuadrado del valor de la desviación estandar, como se muestra a continuación.\\ 
		...
		\subsection{Eigenvalores y Eigenvectores}
			...
			Se conocen como valores propios de una matriz al conjunto de valores que resuleven la ecuación:\\
			...
			Tambien puede observarse que $\lambda$ es un vector de valores escalares que a su vez son solución del polinomio de grado $n$. Donde $n$ es la dimensión de la matriz $A$: \\
			...
			Para encontrar el valor de los vectores caratecterísticos de la matriz A se determinan los valores característicos de la matriz A se resuleve la ecuación:\\
			...
			Es importante resaltar estas dos caraterísticas puesto que la aplicación que se desarrollará en este trabajo se basa en el principio de la indepencia lineal de los vectores propios y que estos construyen una base ortogonal del conjunto de datos observados.
