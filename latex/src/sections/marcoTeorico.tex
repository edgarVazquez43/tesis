...
Los principales parámetros que caracterizan a los robots industriales son:
	...
	\begin{itemize}
		...
		\item{Velocidad. Es la máxima velocidad que alcanzan el actuador final y las articulaciones.}
	\end{itemize}
...
%%  ----------------------------------------------
	\section{Imágenes RGB-D}
		...
		Debido a que el patrón de puntos es relativamente al azar, la coincidencia entre la imagen IR y el patrón del proyector puede realizarse de forma directa comparando pequeñas vecindades utilizando, por ejemplo, referencias cruzadas.\\ %REFFFF
