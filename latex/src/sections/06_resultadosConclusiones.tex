	...
	****Gráficas de eventos, reslatando exitos-fracacsos
	...
	\begin{table}[H]
		...
		\begin{tabular}{ |p{2.8cm}|p{0.4cm}|p{0.4cm}|p{0.4cm}|p{0.4cm}|p{0.4cm}|p{0.4cm}|p{0.4cm}|p{0.4cm}|p{0.4cm}|p{0.4cm}|  }
		 ...
		 \hline 
		  Control de videojuegos & $\times$ & $\times$ & $\times$ & $\times$ & $\times$ & $\bigtriangleup$ & $\times$ & $\times$ & $\times$ & $\times$ \\
		 \hline
		  Barra de chocolate     & $\times$ & $\times$ & $\times$ & $\times$ & $\times$ & $\bigtriangleup$ & $\times$ & $\times$ & $\times$ & $\times$\\
		 \hline
