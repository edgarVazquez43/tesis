...
\begin{table}[H]
	...
	\begin{tabular}{ |p{2.0cm}|p{2.2cm}|p{2.2cm}|p{2.2cm}|p{2.2cm}|p{2.2cm}|  }
	 ...
	 \hline
	 \textbf{Objeto} &\textbf{Altura media [m]}  &\textbf{Varianza}&\textbf{Altura media [m]}  &\textbf{Varianza} &\\
	 \hline
	  Cereal    &	 0.2568  &     & 0.2324  & &$p_{value} < 2.2e^{-16}$  \\
	 \hline
	  Jugo      &    0.1407  &     & 0.1305 & &$p_{value} < 2.1e^{-16}$  \\
	 \hline
	  Leche     &    0.0901  &     & 0.0889 & &$p_{value} < 2.1e^{-16}$  \\
	 \hline 
	  Control de videojuegos &  0.0485  &   &0.0411 & & $p_{value} = 0.0175$ \\
	 \hline
	  Barra de chocolate   &    0.0215  &   &0.0213 & & $p_{value} = 0.1335$ \\
	 \hline
	\end{tabular}
...
%%%%%%%%%% PRUEBAS GRASPEO CON DIFERENTES INFORMACIONES %%%%%%%%%%%%
	...
	Las pruebas se realizaron en 20 eventos para cada uno de los 5 diferentes objetos.\\
	5 de ellos se realizaron con el objeto a 0 grados respeco al eje y del robot.\\
	5 ocasiones el objeto se encontraba a 30$^{\circ}$ respecto al eje y del robot.\\
	5 ocasiones el objeto se encontraba a 60$^{\circ}$ respecto al eje y del robot.\\
	5 ocasiones el objeto se encontraba a 90$^{\circ}$ respecto al eje y del robot.\\	
