...
%%%%%%%%% Cálculo de las orientaciones  %%%%%%%%%%%%%%%%%%%%
	...
	\end{itemize}  
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_cereal.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_jugo.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_milk.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_joystick.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_chocolate.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_cereal_45.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_jugo_45.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_milk_45.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_joystick_45.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_chocolate_45.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_cereal_90.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_jugo_90.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_milk_90.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_joystick_90.png}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.45]{resultados/angulos_chocolate_90.png}
...
%%%%%%%%%% PRUEBAS DE GRASPEO CON INFORMACIÓN DEL ÁREA DE TRABAJO  %%%%%%%%%%%%
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.45]{resultados/success_IKcalculate.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.45]{resultados/unsuccess_IKcalculate.png}
		\caption{Gráfica de tiempo de ejecución para el cálculo de la cinemática inversa por metodo geométrico(rojo) y por método númerico (azul). Caso de solución no encontrada.}
		\label{fig:mesh1}
	\end{figure}
...
%%%%%%%%%% PRUEBAS GRASPEO CON DIFERENTES INFORMACIONES %%%%%%%%%%%%
	...
	Como reporte último de las pruebas, se realizaron pruebas fisicas con el robot de servicio Justina. Para tener una prueba estadistica que pueda servir de compración se realizaron un total de 35 eventos, divididos en 5 repeticiones para 5 objetos. Los objetos con los cuales se realizaon las pruebas fueron: una caja de cereal, un envase de jugo, un envase de bebida lactea, un control de videojuegos, una barra de chocolate, un libro y una bolsa de cartón.\\

	Las orientaciones de los objetos en cada uno de los eventos fueron posicione aleatorias. Esto con el fin de poner a prueba las caracteristicas de presición en la orientación de los objetos para este algoritmo.\\
	...
	****Imagenes objetos.\\
	...
	Los resultados se muestran en una tabla de éxitos contra fracasos para cada una de las implemetaciones.\\



		\subsection{Pruebas de manipulación actual.}

	***Imagenes representativas de los resultados.\\
	...
	\begin{table}[H]
		...
		\begin{tabular}{ |p{2.8cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|  }
		 \hline
		 & \multicolumn{5}{|c|}{\textbf{Eventos} }\\
		 \hline
		  Cereal & $\bigtriangleup$ & $\times$ & $\times$ & $\times$ & $\times$ \\
		 \hline
		  Jugo   & $\times$ & $\bigtriangleup$ & $\times$ & $\bigtriangleup$ & $\times$ \\
		 \hline
		  Leche  & $\bigtriangleup$ & $\bigtriangleup$ & $\bigtriangleup$ & $\times$ & $\times$\\
		 \hline 
		  Control de videojuegos & $\times$ & $\times$ & $\times$ & $\times$ & $\times$\\
		 \hline
		  Barra de chocolate     & $\times$ & $\times$ & $\times$ & $\times$ & $\times$\\
		 \hline
		  Libro   & $\times$ & $\times$ & $\times$ & $\times$ & $\times$\\
		 \hline
		 Bolsa de cartón  & $\bigtriangleup$ & $\times$ & $\times$ & $\bigtriangleup$ & $\times$\\
		 \hline
		\end{tabular}
		\caption{Tabla de resultados de la prueba T a medidas repetidas.}
		\label{t_test:1}
