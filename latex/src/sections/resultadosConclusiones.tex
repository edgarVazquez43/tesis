...
En esta sección analizaremos los resultados obtenidos al probar el algoritmo RANSAC para encontrar planos modificando el numero de iteraciones. Observaremos el comportamiento del error y el tiempo de ejecución a fin de encontrar el número óptimo de iteraciones para este algoritmo.\\
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/x_pRojo.jpg}	
		\end{subfigure}\\
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/y_pRojo.jpg}
		\end{subfigure}\\
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/z_pRojo.jpg}
		\end{subfigure}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/x_chocolate.jpg}	
		\end{subfigure}\\
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/y_chocolate.jpg}
		\end{subfigure}\\
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/z_chocolate.jpg}
		\end{subfigure}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/x_jugo.jpg}	
		\end{subfigure}\\
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/y_jugo.jpg}
		\end{subfigure}\\
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/z_jugo.jpg}
		\end{subfigure}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/x_milk.jpg}	
		\end{subfigure}\\
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/y_milk.jpg}
		\end{subfigure}\\
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/z_milk.jpg}
		\end{subfigure}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/x_pringles.jpg}	
		\end{subfigure}\\
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/y_pringles.jpg}
		\end{subfigure}\\
		\begin{subfigure}[h]{.5\textwidth}
		\includegraphics[width=14.5cm, height=6.0cm]{/z_pringles.jpg}
		\end{subfigure}
	...
	\begin{figure}[H]
		\includegraphics[width=14.5cm, height=7.0cm]{/DesviacionEstandar.jpg}	
		\caption{Gráficas de coordenadas en centroide de una barra de chocolate.}
	\end{figure}
