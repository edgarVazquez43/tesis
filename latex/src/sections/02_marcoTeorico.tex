...
Los principales parámetros que caracterizan a los robots industriales son:
	...
	\begin{itemize}
		\item{Número de grados de libertad. Puede entenderse como número total de variables necesarias para obtener la ubicación de un cuerpo en el espacio. Aunque la mayoría de las aplicaciones requieren manipuladores de 6 g.d.l., otras más complejas requieren un número mayor, tal es el caso de las labores de apertura y cierre de puertas.}
	...
	\end{itemize}
		...
		\subsection{Cinemática directa}
			...
			Este tema se abordará con más detalle en el capítulo de este documento.\\
