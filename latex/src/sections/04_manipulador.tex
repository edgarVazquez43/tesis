...
Se utiliza un vector que representa la posición del codo con respecto al sistema del mimsmo codo:\\ 
...
posteriormente se obtinene la matriz de tranfomación inversa, para calcular la posición de la muñeca:\\ 
