...
\end{figure}
    ...
    \begin{figure}[H]
		\begin{center}
		\includegraphics[scale=0.4]{manipulator/par_calc.png}
		\end{center}
	...
	A continuación se muestra una tabla con las caracteriticas más reelevantes de los registros que posee cada uno de los revomotores dynamixel.\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\section{Descripción de los elementos del sistema de manipulación}
		...
		\begin{SCfigure}
			\includegraphics[scale=0.4]{manipulator/brazo_4.jpg}
