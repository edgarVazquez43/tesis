...
def main(portName, portBaud):
    ...
    data_str = ""
    headline_str = ""
    file_txt = open("servo["+str(servo)+"]_attempt_[9].txt", "w")
    error_txt = open("error_s["+str(servo)+"].txt", "a")
    #error_txt.write("Datos perdidos por cada iteracion para el servo #"+str(servo)+" \n \n")
    ...
    headline_str = "Data's result for reading position of each one Dynamixel Servomotors Right_arm at " + str(portBaud) + " Baudrate for 1000 datas transmition \n \n \n"
