...
int main(int argc, char** argv)
{
    ...
    cltIKinematicsLA = n.serviceClient<manip_msgs::InverseKinematicsFloatArray>("/control/ik_moveit/la_inverse_kinematics");
    cltIKinematicsRA = n.serviceClient<manip_msgs::InverseKinematicsFloatArray>("/control/ik_moveit/ra_inverse_kinematics");

    marker_pub = n.advertise<visualization_msgs::Marker>("visualization_marker", 10);


    // Data request to direct kinematic
    cartesian.push_back( 0.035);
    cartesian.push_back(-0.225);        
    cartesian.push_back(0.86);
    cartesian.push_back(0.0);      // yaw
    cartesian.push_back(0.0);      // pitch
