...
void markerSetup()
{
  ...
  wristCenter.header.frame_id = "base_link";    
...
int main(int argc, char** argv)
{
    ...
    std::cout << "x_wc: " << wristPosition[0] << std::endl;
    std::cout << "y_wc: " << wristPosition[1] << std::endl;
    std::cout << "z_wc: " << wristPosition[2] << std::endl;
